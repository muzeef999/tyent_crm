  ...
  return (
    <div className="flex flex-col sm:flex-row gap-4">
      ...
      <div className={cardStyle}>
        ...
        <p className="text-sm text-gray-500 mt-1">un satisfied Customer</p>
      </div>
      ...
      <div className={cardStyle}>
        ...
        <p className="text-sm text-gray-500 mt-1">Not Assigned Services</p>
      </div>
      ...
      <div className={cardStyle}>
        ...
        <p className="text-sm text-gray-500 mt-1">Pending Services</p>
      </div>
    </div>
  );
};
